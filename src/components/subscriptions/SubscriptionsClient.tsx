...
export default function SubscriptionsClient() {
  ...
  const [subscriptionToLog, setSubscriptionToLog] = useState<Subscription | null>(null)
              ...
              <div
                ...
                className={`relative flex flex-col rounded-xl border ${
                  sub.status === "paused"
                    ...
                    : "border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-slate-800 dark:bg-slate-900"
                } p-6`}
              >
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      ...
                      style={{
                        backgroundColor:
                          sub.category?.color ||
                          (sub.status === "paused" ? "#94a3b8" : "#6366f1"),
                      }}
                    >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400">
                        {sub.category?.name || t("uncategorized")}
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-5 flex items-end justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                      {sub.billingCycle === "monthly" ? t("perMonth") : t("perYear")}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 flex w-full flex-col gap-2">
                  <button
                    ...
                    className="inline-flex w-full cursor-pointer items-center justify-center rounded-md bg-emerald-50 px-3 py-2 text-sm font-medium text-emerald-700 transition-colors hover:bg-emerald-100 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-emerald-500/10 dark:text-emerald-400 dark:hover:bg-emerald-500/20"
                  >
                  ...
                  <div className="flex w-full gap-2">
                    <button
                      ...
                      className="inline-flex flex-1 cursor-pointer items-center justify-center rounded-md bg-slate-50 px-3 py-1.5 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
                    >
                    ...
                    <button
                      ...
                      disabled={isDeleting}
                      className="inline-flex cursor-pointer items-center justify-center rounded-md bg-red-50 px-3 py-1.5 text-sm font-medium text-red-700 transition-colors hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/20"
                    >
